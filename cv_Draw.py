...
imageLine = cv2.line(Img, start_point, end_point, color, thickness) #LINE
#imageArrow = cv2.arrowedLine(Img, start_point, end_point,color, thickness) # ARROW

# Display the image
cv2.imshow('Drawing_Line', imageLine)
cv2.waitKey(0)
